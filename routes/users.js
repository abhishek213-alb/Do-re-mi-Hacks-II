...
router.get('/game2/:id', passport.checkAuthentication,usersController.game2);
router.post('/update/:id', passport.checkAuthentication,usersController.update);
router.post('/update_game1/:id', passport.checkAuthentication,usersController.update_game1);
router.post('/update_game2/:id', passport.checkAuthentication,usersController.update_game2);
